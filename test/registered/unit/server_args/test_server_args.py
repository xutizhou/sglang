...
class TestUltraEPArgs(CustomTestCase):
    def test_ultraep_reserves_global_slots_and_disables_unsupported_paths(self):
        ...
        # The dummy path skips the normal handler pipeline. Materialize the
        # resolved config that _handle_eplb_and_dispatch consumes without
        # running model-dependent CUDA graph compatibility checks.
